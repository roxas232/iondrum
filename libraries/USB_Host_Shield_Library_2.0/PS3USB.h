...
#define PS3_ION_VID				0x12BA	// ION Corporation
#define PS3_ION_PID				0x0210	// ION Drum Rocker Controller
...
public:
        ...
        virtual bool VIDPIDOK(uint16_t vid, uint16_t pid) {
				if (vid == PS3_ION_VID && pid == PS3_ION_PID) return true;
