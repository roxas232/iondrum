...
void loop() {
  ...
  if (Xbox.XboxConnected) {
    if (Xbox.getButtonPress(BLACKBTN) || Xbox.getButtonPress(WHITEBTN)) {
      Serial.print("BLACK: ");
      Serial.print(Xbox.getButtonPress(BLACKBTN));
      Serial.print("\tWHITE: ");
      Serial.println(Xbox.getButtonPress(WHITEBTN));
      Xbox.setRumbleOn(Xbox.getButtonPress(BLACKBTN), Xbox.getButtonPress(WHITEBTN));
    } else
